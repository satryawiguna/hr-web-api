...
class CreateRegistrationLettersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('registration_letters', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('registration_letters');
    }
}
