...
use App\Exports\HumanResources\MasterData\CompetenceExport;
...
class CompetenceController extends Controller
{
    ...
    private $_competenceServiceInterface;
     ...
     * @param CompetenceServiceInterface $competenceServiceInterface
     */
    public function __construct(CompetenceServiceInterface $competenceServiceInterface)
    {
        $this->_competenceServiceInterface = $competenceServiceInterface;
    }
     ...
     */
    public function getCompetenceList(Request $request)
    {
        $companyId = $request->get('company_id');
        $isActive = $request->get('is_active');

        return $this->getListJson($companyId, $isActive,
            [$this->_competenceServiceInterface, 'competenceList'],
     ...
     *                  @OA\Property(property="is_active", ref="#/components/schemas/CompetenceEloquent/properties/is_active")
     *              )
     *          )
     *     ),
     *     @OA\Response(
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postCompetenceListSearch(Request $request)
    {
        $companyId = $request->input('company_id');
        $isActive = $request->input('is_active');

        return $this->getListSearchJson($request, $companyId, $isActive,
            [$this->_competenceServiceInterface, 'competenceListSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
     ...
     * @return mixed
     */
    public function postCompetencePageSearch(Request $request)
    {
        $companyId = $request->input('company_id');
        $isActive = $request->input('is_active');

        return $this->getPagedSearchJson($request, $companyId, $isActive,
            [$this->_competenceServiceInterface, 'competencePageSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getCompetenceDetail(int $id)
    {
        return $this->getDetailObjectJson($id,
            [$this->_competenceServiceInterface, 'find'],
            function ($entity) {
                $rowJsonData = new Collection();
     ...
     * @return mixed
     */
    public function postCompetenceCreate(Request $request)
    {
        $competence = $this->_competenceServiceInterface->newInstance();

        $competence->company_id = $request->input('company_id');
        $competence->code = $request->input('code');
        $competence->name = $request->input('name');
        $competence->slug = $request->input('slug');
        $competence->description = $request->input('description');

        $this->setRequestAuthor($competence);

        $response = $this->_competenceServiceInterface->create($competence);
        $competenceCreated = $response->getObject();

        if (!$response->isSuccess()) {
            return $this->getBasicErrorJson($response);
        }

        return $this->getBasicSuccessJson($response, $competenceCreated);
    }

    /**
     * @OA\Put(
     *     path="/competence/update",
     ...
     *          @OA\MediaType(
     *              mediaType="application/json",
     *              @OA\Schema(ref="#/components/schemas/UpdateCompetenceEloquent")
     *          )
     *     ),
     *     @OA\Response(
     *          response=200,
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putCompetenceUpdate(Request $request)
    {
        $application = $this->_competenceServiceInterface->find($request->input('id'));
        ...
        $response = $this->_competenceServiceInterface->update($result);
    ...
    {
        $application = $this->_competenceServiceInterface->find($id);

        $result = $application->getObject();

        $response = $this->_competenceServiceInterface->delete($result);
     ...
     */
    public function deleteBulkCompetence(Request $request)
    {
        $ids = $request->input('ids');

        $response = $this->_competenceServiceInterface->deleteBulk($ids);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putCompetenceActive(Request $request)
    {
        $application = $this->_competenceServiceInterface->find($request->input('id'));
        ...
        $response = $this->_competenceServiceInterface->competenceSetActive($result);
    ...
    /**
     * @OA\Get(
     *     path="/competence/slug/{company_id}/{name}",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getCompetenceSlug(int $companyId, string $name)
    {
        return $this->getSlugObjectJson($companyId, $name,
            [$this->_competenceServiceInterface, 'competenceSlug'],
            function ($entity) {
                $rowJsonData = new Collection();
    ...
    /**
     * @OA\Post(
     *     path="/competence/list-search/export",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postCompetenceListSearchExport(Request $request)
    {
    ...
    private function generateExcel(Collection $entities, string $ext = null) {
        ...
        if (Excel::store(new CompetenceExport($entities), $path . $file)) {
    ...
    private function generatePDF(Collection $entities, string $ext = null) {
        ...
        if (PDF::loadView('exports.human-resources.master-data.competence', ['competences' => $entities])
    ...
    private function getSlugObjectJson(int $companyId, string $name,
                                       ...
                                       callable $dtoObjectToJsonMethod)
    {
        $module = $this->_competenceServiceInterface->newInstance();
