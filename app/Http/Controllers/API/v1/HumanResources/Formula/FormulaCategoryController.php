...
use App\Exports\HumanResources\Formula\FormulaCategoryExport;
...
class FormulaCategoryController extends Controller
{
    use BaseController;
    ...
    private $_formulaCategoryServiceInterface;
    ...
    public function __construct(FormulaCategoryServiceInterface $formulaCategoryServiceInterface)
    {
        $this->_formulaCategoryServiceInterface = $formulaCategoryServiceInterface;
    }
     ...
     */
    public function getFormulaCategoryList()
    {
        return $this->getListJson([$this->_formulaCategoryServiceInterface, 'formulaCategoryList'],
    ...
    /**
     * @OA\Post(
     *     path="/formula-category/list-search",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postFormulaCategoryListSearch(Request $request)
    {
        return $this->getListSearchJson($request,
            [$this->_formulaCategoryServiceInterface, 'formulaCategoryListSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
    ...
    /**
     * @OA\Post(
     *     path="/formula-category/page-search",
     ...
     * @return mixed
     */
    public function postFormulaCategoryPageSearch(Request $request)
    {
        return $this->getPagedSearchJson($request,
            [$this->_formulaCategoryServiceInterface, 'formulaCategoryPageSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
    ...
    /**
     * @OA\Get(
     *     path="/formula-category/detail/{id}",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getFormulaCategoryDetail(int $id)
    {
        return $this->getDetailObjectJson($id,
            [$this->_formulaCategoryServiceInterface, 'find'],
            function ($entity) {
                $rowJsonData = new Collection();
     ...
     *          @OA\MediaType(
     *              mediaType="application/json",
     *              @OA\Schema(ref="#/components/schemas/CreateFormulaCategoryEloquent")
     *          )
     *     ),
     *     @OA\Response(
     *          response=200,
     ...
     * @return mixed
     */
    public function postFormulaCategoryCreate(Request $request)
    {
        $formulaCategory = $this->_formulaCategoryServiceInterface->newInstance();

        $formulaCategory->name = $request->input('name');
        $formulaCategory->slug = $request->input('slug');
        $formulaCategory->description = $request->input('description');

        $this->setRequestAuthor($formulaCategory);

        $response = $this->_formulaCategoryServiceInterface->create($formulaCategory);
        $formulaCategoryCreated = $response->getObject();

        if (!$response->isSuccess()) {
            return $this->getBasicErrorJson($response);
        }

        return $this->getBasicSuccessJson($response, $formulaCategoryCreated);
    }

    /**
     * @OA\Put(
     *     path="/formula-category/update",
     ...
     *          @OA\MediaType(
     *              mediaType="application/json",
     *              @OA\Schema(ref="#/components/schemas/UpdateFormulaCategoryEloquent")
     *          )
     *     ),
     *     @OA\Response(
     *          response=200,
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putFormulaCategoryUpdate(Request $request)
    {
        $formulaCategory = $this->_formulaCategoryServiceInterface->find($request->input('id'));

        $result = $formulaCategory->getObject();
        ...
        $response = $this->_formulaCategoryServiceInterface->update($result);
    ...
    /**
     * @OA\Delete(
     *     path="/formula-category/delete/{id}",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postFormulaCategoryDelete(int $id)
    {
        $formulaCategory = $this->_formulaCategoryServiceInterface->find($id);

        $result = $formulaCategory->getObject();

        $response = $this->_formulaCategoryServiceInterface->delete($result);
     ...
     */
    public function deleteBulkFormulaCategory(Request $request)
    {
        $ids = $request->input('ids');

        $response = $this->_formulaCategoryServiceInterface->deleteBulk($ids);
    ...
    /**
     * @OA\Get(
     *     path="/formula-category/slug/{name}",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getFormulaCategorySlug(string $name)
    {
        return $this->getSlugObjectJson($name,
            [$this->_formulaCategoryServiceInterface, 'formulaCategorySlug'],
            function ($entity) {
                $rowJsonData = new Collection();
    ...
    /**
     * @OA\Post(
     *     path="/formula-category/list-search/export",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postFormulaCategoryListSearchExport(Request $request)
    {
        $export = $request->input('export');

        return $this->getListSearchExportJson($request, $export,
            [$this->_formulaCategoryServiceInterface, 'formulaCategoryListSearch'],
    ...
    private function generateExcel(Collection $entities, string $ext = null) {
        ...
        if (Excel::store(new FormulaCategoryExport($entities), $path . $file)) {
    ...
    private function generatePDF(Collection $entities, string $ext = null) {
        ...
        if (PDF::loadView('exports.human-resources.formula.formula-category', ['formulaCategories' => $entities])
    ...
    {
        $formulaCategory = $this->_formulaCategoryServiceInterface->newInstance();
        $formulaCategory->name = $name;

        $response = $searchMethod($formulaCategory);
        $itemJsonData = $dtoObjectToJsonMethod($response->getObject());
