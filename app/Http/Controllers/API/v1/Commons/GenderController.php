...
use App\Exports\Commons\GenderExport;
...
class GenderController extends Controller
{
    ...
    private $_genderServiceInterface;
     ...
     * @param GenderServiceInterface $genderServiceInterface
     */
    public function __construct(GenderServiceInterface $genderServiceInterface)
    {
        $this->_genderServiceInterface = $genderServiceInterface;
    }
    ...
    public function getGenderList(Request $request)
    {
        ...
        return $this->getListJson($isActive,
            [$this->_genderServiceInterface, 'genderList'],
     ...
     *                      example="keyword"
     *                  ),
     *                  @OA\Property(property="is_active", ref="#/components/schemas/GenderEloquent/properties/is_active")
     *              )
     *          )
     *     ),
     *     @OA\Response(
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postGenderListSearch(Request $request)
    {
        $isActive = $request->input('is_active');

        return $this->getListSearchJson($request, $isActive,
            [$this->_genderServiceInterface, 'genderListSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
     ...
     * @return mixed
     */
    public function postGenderPageSearch(Request $request)
    {
        $isActive = $request->input('is_active');

        return $this->getPagedSearchJson($request, $isActive,
            [$this->_genderServiceInterface, 'genderPageSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getGenderDetail(int $id)
    {
        return $this->getDetailObjectJson($id,
            [$this->_genderServiceInterface, 'find'],
            function ($entity) {
                $rowJsonData = new Collection();
     ...
     * @return mixed
     */
    public function postGenderCreate(Request $request)
    {
        $gender = $this->_genderServiceInterface->newInstance();

        $gender->name = $request->input('name');
        $gender->slug = $request->input('slug');
        $gender->description = $request->input('description');

        $this->setRequestAuthor($gender);

        $response = $this->_genderServiceInterface->create($gender);
        $genderCreated = $response->getObject();

        if (!$response->isSuccess()) {
            return $this->getBasicErrorJson($response);
        }

        return $this->getBasicSuccessJson($response, $genderCreated);
    }
     ...
     *          @OA\MediaType(
     *              mediaType="application/json",
     *              @OA\Schema(ref="#/components/schemas/UpdateGenderEloquent")
     *          )
     *     ),
     *     @OA\Response(
     *          response=200,
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putGenderUpdate(Request $request)
    {
        $gender = $this->_genderServiceInterface->find($request->input('id'));

        $result = $gender->getObject();
        ...
        $response = $this->_genderServiceInterface->update($result);
        $genderUpdated = $response->getObject();

        if (!$response->isSuccess()) {
            return $this->getBasicErrorJson($response);
        }

        return $this->getBasicSuccessJson($response, $genderUpdated);
    }

    /**
     * @OA\Delete(
     *     path="/gender/delete/{id}",
    ...
    {
        $gender = $this->_genderServiceInterface->find($id);

        $result = $gender->getObject();

        $response = $this->_genderServiceInterface->delete($result);
     ...
     */
    public function deleteBulkGender(Request $request)
    {
        $ids = $request->input('ids');

        $response = $this->_genderServiceInterface->deleteBulk($ids);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putGenderActive(Request $request)
    {
        $gender = $this->_genderServiceInterface->find($request->input('id'));
        ...
        $response = $this->_genderServiceInterface->genderSetActive($result);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getGenderSlug(string $name)
    {
        return $this->getSlugObjectJson($name,
            [$this->_genderServiceInterface, 'genderSlug'],
            function ($entity) {
                $rowJsonData = new Collection();
    ...
    /**
     * @OA\Post(
     *     path="/gender/list-search/export",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postGenderListSearchExport(Request $request)
    {
    ...
    private function generateExcel(Collection $entities, string $ext = null) {
        ...
        if (Excel::store(new GenderExport($entities), $path . $file)) {
    ...
    private function generatePDF(Collection $entities, string $ext = null) {
        ...
        if (PDF::loadView('exports.commons.gender', ['genders' => $entities])
