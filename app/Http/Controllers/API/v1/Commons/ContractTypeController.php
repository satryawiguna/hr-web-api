...
use App\Exports\Commons\ContractTypeExport;
...
class ContractTypeController extends Controller
{
    ...
    private $_contractTypeServiceInterface;
    ...
    /**
     * ContractTypeController constructor.
     * @param ContractTypeServiceInterface $contractTypeServiceInterface
     */
    public function __construct(ContractTypeServiceInterface $contractTypeServiceInterface)
    {
        $this->_contractTypeServiceInterface = $contractTypeServiceInterface;
    }
    ...
    public function getContractTypeList(Request $request)
    {
        ...
        return $this->getListJson($isActive,
            [$this->_contractTypeServiceInterface, 'contractTypeList'],
    ...
    /**
     * @OA\Post(
     *     path="/contract-type/list-search",
     ...
     *                      example="keyword"
     *                  ),
     *                  @OA\Property(property="is_active", ref="#/components/schemas/ContractTypeEloquent/properties/is_active")
     *              )
     *          )
     *     ),
     *     @OA\Response(
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postContractTypeListSearch(Request $request)
    {
        $isActive = $request->input('is_active');

        return $this->getListSearchJson($request, $isActive,
            [$this->_contractTypeServiceInterface, 'contractTypeListSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
    ...
    /**
     * @OA\Post(
     *     path="/contract-type/page-search",
     ...
     * @return mixed
     */
    public function postContractTypePageSearch(Request $request)
    {
        $isActive = $request->input('is_active');

        return $this->getPagedSearchJson($request, $isActive,
            [$this->_contractTypeServiceInterface, 'contractTypePageSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getContractTypeDetail(int $id)
    {
        return $this->getDetailObjectJson($id,
            [$this->_contractTypeServiceInterface, 'find'],
            function ($entity) {
                $rowJsonData = new Collection();
     ...
     * @return mixed
     */
    public function postContractTypeCreate(Request $request)
    {
        $contractType = $this->_contractTypeServiceInterface->newInstance();

        $contractType->name = $request->input('name');
        $contractType->slug = $request->input('slug');
        $contractType->description = $request->input('description');

        $this->setRequestAuthor($contractType);

        $response = $this->_contractTypeServiceInterface->create($contractType);
        $contractTypeCreated = $response->getObject();

        if (!$response->isSuccess()) {
            return $this->getBasicErrorJson($response);
        }

        return $this->getBasicSuccessJson($response, $contractTypeCreated);
    }
     ...
     *          @OA\MediaType(
     *              mediaType="application/json",
     *              @OA\Schema(ref="#/components/schemas/UpdateContractTypeEloquent")
     *          )
     *     ),
     *     @OA\Response(
     *          response=200,
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putContractTypeUpdate(Request $request)
    {
        $contractType = $this->_contractTypeServiceInterface->find($request->input('id'));

        $result = $contractType->getObject();
        ...
        $response = $this->_contractTypeServiceInterface->update($result);
        $contractTypeUpdated = $response->getObject();

        if (!$response->isSuccess()) {
            return $this->getBasicErrorJson($response);
        }

        return $this->getBasicSuccessJson($response, $contractTypeUpdated);
    }

    /**
     * @OA\Delete(
     *     path="/contract-type/delete/{id}",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function deleteContractType(int $id)
    {
        $contractType = $this->_contractTypeServiceInterface->find($id);

        $result = $contractType->getObject();

        $response = $this->_contractTypeServiceInterface->delete($result);
     ...
     */
    public function deleteBulkContractType(Request $request)
    {
        $ids = $request->input('ids');

        $response = $this->_contractTypeServiceInterface->deleteBulk($ids);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putContractTypeActive(Request $request)
    {
        $contractType = $this->_contractTypeServiceInterface->find($request->input('id'));
        ...
        $response = $this->_contractTypeServiceInterface->contractTypeSetActive($result);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getContractTypeSlug(string $name)
    {
        return $this->getSlugObjectJson($name,
            [$this->_contractTypeServiceInterface, 'contractTypeSlug'],
            function ($entity) {
                $rowJsonData = new Collection();
    ...
    /**
     * @OA\Post(
     *     path="/contract-type/list-search/export",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postContractTypeListSearchExport(Request $request)
    {
    ...
    private function generateExcel(Collection $entities, string $ext = null) {
        ...
        if (Excel::store(new ContractTypeExport($entities), $path . $file)) {
    ...
    private function generatePDF(Collection $entities, string $ext = null) {
        ...
        if (PDF::loadView('exports.commons.contract-type', ['contractTypes' => $entities])
                                       ...
                                       callable $dtoObjectToJsonMethod)
    {
        ...
        $response = $searchMethod($contractType);
        $itemJsonData = $dtoObjectToJsonMethod($response->getObject());
