...
class GroupController extends Controller
{
    ...
    private $_groupServiceInterface;
     ...
     * @param GroupServiceInterface $groupServiceInterface
     */
    public function __construct(GroupServiceInterface $groupServiceInterface)
    {
        $this->_groupServiceInterface = $groupServiceInterface;
    }
    ...
    public function getGroupList(Request $request)
    {
        ...
        return $this->getListJson($isActive,
            [$this->_groupServiceInterface, 'groupList'],
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postGroupListSearch(Request $request)
    {
        $isActive = $request->input('is_active');

        return $this->getListSearchJson($request, $isActive,
            [$this->_groupServiceInterface, 'groupListSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
     ...
     * @return mixed
     */
    public function postGroupPageSearch(Request $request)
    {
        $isActive = $request->input('is_active');

        return $this->getPagedSearchJson($request, $isActive,
            [$this->_groupServiceInterface, 'groupPageSearch'],
            function (Collection $entities) {
                $rowJsonData = new Collection();
    ...
    public function getGroupDetail(int $id)
    {
        return $this->getDetailObjectJson($id,
            [$this->_groupServiceInterface, 'find'],
            function ($entity) {
                $rowJsonData = new Collection();
    ...
    {
        $group = $this->_groupServiceInterface->newInstance();
        ...
        $this->setRequestAuthor($group);

        $response = $this->_groupServiceInterface->create($group);
        $groupCreated = $response->getObject();

        if (!$response->isSuccess()) {
            return $this->getBasicErrorJson($response);
        }

        return $this->getBasicSuccessJson($response, $groupCreated);
    }
     ...
     *          @OA\MediaType(
     *              mediaType="application/json",
     *              @OA\Schema(ref="#/components/schemas/UpdateGroupEloquent")
     *          )
     *     ),
     *     @OA\Response(
     *          response=200,
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putGroupUpdate(Request $request)
    {
        $group = $this->_groupServiceInterface->find($request->input('id'));
        ...
        $response = $this->_groupServiceInterface->update($result);
    ...
    {
        $group = $this->_groupServiceInterface->find($id);

        $result = $group->getObject();

        $response = $this->_groupServiceInterface->delete($result);
     ...
     */
    public function deleteBulkGroup(Request $request)
    {
        $ids = $request->input('ids');

        $response = $this->_groupServiceInterface->deleteBulk($ids);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function putGroupActive(Request $request){
        $group = $this->_groupServiceInterface->find($request->input('id'));
        ...
        $response = $this->_groupServiceInterface->groupSetActive($result);
 ...
 *          in="path",
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getGroupSlug(string $name)
    {
        return $this->getSlugObjectJson($name,
            [$this->_groupServiceInterface, 'groupSlug'],
            function ($entity) {
                $rowJsonData = new Collection();
