 ...
 * GradeEloquent.
 */
class GradeEloquent extends EloquentAbstract implements GradeInterface
{
     ...
     * @var string
     */
    protected $table =  GradeInterface::TABLE_NAME;
    ...
    {
        return $this->hasMany(PositionMutationEloquent::class, 'grade_id');
    }
...
/**
 * @OA\Schema(
 *     schema="CreateGradeEloquent",
 *     description="Create grade eloquent",
 *     title="Create grade eloquent",
 *     required={"company_id", "name", "slug"},
 *     @OA\Property(property="company_id", ref="#/components/schemas/GradeEloquent/properties/company_id"),
 *     @OA\Property(property="name", ref="#/components/schemas/GradeEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/GradeEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/GradeEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateGradeEloquent",
 ...
 *              )
 *          ),
 *          @OA\Schema(ref="#/components/schemas/CreateGradeEloquent")
 *     }
 * )
 */
