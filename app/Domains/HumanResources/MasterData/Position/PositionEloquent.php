 ...
 * PositionEloquent.
 */
class PositionEloquent extends EloquentAbstract implements PositionInterface
{
     ...
     * @var string
     */
    protected $table = PositionInterface::TABLE_NAME;
     ...
     */
    protected $fillable = [
        'parent_id', 'company_id', 'code', 'name', 'slug', 'description', 'is_active', 'created_by', 'modified_by'
    ];
    ...
    {
        return $this->belongsTo(PositionEloquent::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(PositionEloquent::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(PositionMutationEloquent::class, 'position_id');
    }
 ...
 *     @OA\Property(property="code", ref="#/components/schemas/PositionEloquent/properties/code"),
 *     @OA\Property(property="name", ref="#/components/schemas/PositionEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/PositionEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/PositionEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdatePositionEloquent",
