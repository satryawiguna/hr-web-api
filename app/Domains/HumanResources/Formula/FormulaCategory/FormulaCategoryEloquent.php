 ...
 */
class FormulaCategoryEloquent extends EloquentAbstract implements FormulaCategoryInterface
{
     ...
     * @var string
     */
    protected $table =  FormulaCategoryInterface::TABLE_NAME;
    ...
    {
        return $this->hasMany(FormulaEloquent::class, 'formula_id');
    }
...
/**
 * @OA\Schema(
 *     schema="CreateFormulaCategoryEloquent",
 *     description="Create formula category eloquent",
 *     title="Create formula category eloquent",
 *     required={"name", "slug"},
 *     @OA\Property(property="name", ref="#/components/schemas/FormulaCategoryEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/FormulaCategoryEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/FormulaCategoryEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateFormulaCategoryEloquent",
