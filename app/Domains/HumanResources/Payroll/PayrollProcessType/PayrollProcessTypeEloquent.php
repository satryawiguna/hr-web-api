...
/**
 * PayrollProcessTypeEloquent.
 */
class PayrollProcessTypeEloquent extends EloquentAbstract implements PayrollProcessTypeInterface
{
     ...
     * @var string
     */
    protected $table =  PayrollProcessTypeInterface::TABLE_NAME;
    ...
    {
        return $this->hasMany(PayrollEloquent::class, 'payroll_id');
    }
