...
/**
 * PayrollBatchEloquent.
 */
class PayrollBatchEloquent extends EloquentAbstract implements PayrollBatchInterface
{
     ...
     * @var string
     */
    protected $table =  PayrollBatchInterface::TABLE_NAME;
