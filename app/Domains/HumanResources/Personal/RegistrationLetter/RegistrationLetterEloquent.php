 ...
 */
class RegistrationLetterEloquent extends EloquentAbstract implements RegistrationLetterInterface
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table =  RegistrationLetterInterface::TABLE_NAME;
...
/**
 * @OA\Schema(
 *     schema="CreateRegistrationLetterEloquent",
 ...
 *     @OA\Property(property="reference_number", ref="#/components/schemas/RegistrationLetterEloquent/properties/reference_number"),
 *     @OA\Property(property="start_date", ref="#/components/schemas/RegistrationLetterEloquent/properties/start_date"),
 *     @OA\Property(property="end_date", ref="#/components/schemas/RegistrationLetterEloquent/properties/end_date"),
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateRegistrationLetterEloquent",
