 ...
 */
class CityService extends ServiceAbstract implements CityServiceInterface
{
    ...
    /**
     * Loads our $repo with the actual Repo associated with our CityInterface
    ...
    public function create(CityInterface $City): ObjectResponse
    {
        ...
        $validator = Validator::make($City->toArray(), [
            'state_id' => 'required',
            'city_name' => 'required'
        ]);
        ...
        try {
            ...
            $response->addSuccessMessageResponse($response->getMessageCollection(), 'City was created', 200);
        } catch (Exception $ex) {
    ...
    public function update(CityInterface $City): BasicResponse
    {
        ...
        try {
            $result = $this->repository->update($City);

            $response->setResult($result);
            $response->addSuccessMessageResponse($response->getMessageCollection(), 'City was updated', 200);
        } catch (Exception $ex) {
            if (method_exists($ex,'getResponse')) {
                $exception = new ErrorException((string) $ex->getResponse()->getBody());
                $response->addErrorMessageResponse($response->getMessageCollection(), json_decode($exception->getMessage(), true)['message'], $ex->getCode());
    ...
    public function delete(CityInterface $City): BasicResponse
    {
        ...
        try {
            ...
            $response->addSuccessMessageResponse($response->getMessageCollection(), 'City was deleted', 200);
        } catch (Exception $ex) {
            if (method_exists($ex,'getResponse')) {
                $exception = new ErrorException((string) $ex->getResponse()->getBody());
                $response->addErrorMessageResponse($response->getMessageCollection(), json_decode($exception->getMessage(), true)['message'], $ex->getCode());
    ...
    public function cityList(int $stateId = null): GenericCollectionResponse
    {
        ...
        try {
            $results = $this->repository->cityList($stateId);
     ...
     */
    public function cityListSearch(ListSearchRequest $listSearchRequest, int $stateId = null): GenericListSearchResponse
    {
        ...
        try {
            ...
            $results = $this->repository->cityListSearch($parameter, $stateId);
            $totalCount = $this->repository->cityListSearch($parameter, $stateId, true);
     ...
     */
    public function cityPageSearch(PageSearchRequest $pageSearchRequest, int $stateId = null): GenericPageSearchResponse
    {
        ...
        try {
            ...
            $results = $this->repository->cityPageSearch($parameter, $stateId);
            $totalCount = $this->repository->cityPageSearch($parameter, $stateId, true);
            if ($pageSearchRequest->draw) {
