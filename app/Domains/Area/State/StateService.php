 ...
 */
class StateService extends ServiceAbstract implements StateServiceInterface
{
    ...
    /**
     * Loads our $repo with the actual Repo associated with our StateInterface
    ...
    public function create(StateInterface $State): ObjectResponse
    {
        ...
        $validator = Validator::make($State->toArray(), [
            'country_id' => 'required',
            'state_name' => 'required'
        ]);
        ...
        try {
            $result = $this->repository->create($State);

            $response->setResult($result);
            $response->addSuccessMessageResponse($response->getMessageCollection(), 'State was created', 200);
        } catch (Exception $ex) {
    ...
    public function update(StateInterface $State): BasicResponse
    {
        ...
        try {
            $result = $this->repository->update($State);

            $response->setResult($result);
            $response->addSuccessMessageResponse($response->getMessageCollection(), 'State was updated', 200);
        } catch (Exception $ex) {
            if (method_exists($ex,'getResponse')) {
                $exception = new ErrorException((string) $ex->getResponse()->getBody());
                $response->addErrorMessageResponse($response->getMessageCollection(), json_decode($exception->getMessage(), true)['message'], $ex->getCode());
    ...
    public function delete(StateInterface $State): BasicResponse
    {
        ...
        try {
            ...
            $response->addSuccessMessageResponse($response->getMessageCollection(), 'State was deleted', 200);
        } catch (Exception $ex) {
            if (method_exists($ex,'getResponse')) {
                $exception = new ErrorException((string) $ex->getResponse()->getBody());
                $response->addErrorMessageResponse($response->getMessageCollection(), json_decode($exception->getMessage(), true)['message'], $ex->getCode());
    ...
    public function stateList(int $countryId = null): GenericCollectionResponse
    {
        ...
        try {
            $results = $this->repository->stateList($countryId);
     ...
     */
    public function stateListSearch(ListSearchRequest $listSearchRequest, int $countryId = null): GenericListSearchResponse
    {
        ...
        try {
            ...
            $results = $this->repository->stateListSearch($parameter, $countryId);
            $totalCount = $this->repository->stateListSearch($parameter, $countryId, true);
     ...
     */
    public function statePageSearch(PageSearchRequest $pageSearchRequest, int $countryId = null): GenericPageSearchResponse
    {
        ...
        try {
            ...
            $results = $this->repository->statePageSearch($parameter, $countryId);
            $totalCount = $this->repository->statePageSearch($parameter, $countryId, true);
            if ($pageSearchRequest->draw) {
