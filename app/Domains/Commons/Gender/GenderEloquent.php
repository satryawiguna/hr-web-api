 ...
 * GenderEloquent.
 */
class GenderEloquent extends EloquentAbstract implements GenderInterface
{
     ...
     * @var string
     */
    protected $table = GenderInterface::TABLE_NAME;
    ...
    {
        return $this->hasMany(EmployeeEloquent::class, 'gender_id');
    }
    ...
    {
        return $this->hasMany(ApplicantEloquent::class, 'gender_id');
    }
...
/**
 * @OA\Schema(
 *     schema="CreateGenderEloquent",
 *     description="Create gender eloquent",
 *     title="Create gender eloquent",
 *     required={"name", "slug"},
 *     @OA\Property(property="name", ref="#/components/schemas/GenderEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/GenderEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/GenderEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateGenderEloquent",
 ...
 *              )
 *          ),
 *          @OA\Schema(ref="#/components/schemas/CreateGenderEloquent")
 *     }
 * )
 */
