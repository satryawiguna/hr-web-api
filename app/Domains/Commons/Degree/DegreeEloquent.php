 ...
 * DegreeEloquent.
 */
class DegreeEloquent extends EloquentAbstract implements DegreeInterface
{
     ...
     * @var string
     */
    protected $table = DegreeInterface::TABLE_NAME;
    ...
    {
        return $this->hasMany(FormalEducationHistoryEloquent::class, 'degree_id');
    }
...
/**
 * @OA\Schema(
 *     schema="CreateDegreeEloquent",
 *     description="Create degree eloquent",
 *     title="Create degree eloquent",
 *     required={"name", "slug"},
 *     @OA\Property(property="name", ref="#/components/schemas/DegreeEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/DegreeEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/DegreeEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateDegreeEloquent",
 ...
 *              )
 *          ),
 *          @OA\Schema(ref="#/components/schemas/CreateDegreeEloquent")
 *     }
 * )
 */
