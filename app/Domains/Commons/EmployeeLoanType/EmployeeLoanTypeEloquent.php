 ...
 */
class EmployeeLoanTypeEloquent extends EloquentAbstract implements EmployeeLoanTypeInterface
{
     ...
     * @var string
     */
    protected $table =  EmployeeLoanTypeInterface::TABLE_NAME;
...
/**
 * @OA\Schema(
 *     schema="CreateEmployeeLoanTypeEloquent",
 *     description="Create employee loan type eloquent",
 *     title="Create employee loan type eloquent",
 *     required={"name", "slug"},
 *     @OA\Property(property="name", ref="#/components/schemas/EmployeeLoanTypeEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/EmployeeLoanTypeEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/EmployeeLoanTypeEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateEmployeeLoanTypeEloquent",
 ...
 *              )
 *          ),
 *          @OA\Schema(ref="#/components/schemas/CreateEmployeeLoanTypeEloquent")
 *     }
 * )
 */
