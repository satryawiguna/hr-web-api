 ...
 */
class EmployeeNumberScaleEloquent extends EloquentAbstract implements EmployeeNumberScaleInterface
{
    use SoftDeletes, SoftCascadeTrait, Sluggable;
     ...
     * @var string
     */
    protected $table = EmployeeNumberScaleInterface::TABLE_NAME;
    ...
    protected $softCascade = ['companies@restrict'];
    ...
    {
        return $this->hasMany(CompanyEloquent::class, 'employee_number_scale_id');
    }
...
/**
 * @OA\Schema(
 *     schema="CreateEmployeeNumberScaleEloquent",
 *     description="Create employee number scale eloquent",
 *     title="Create employee number scale eloquent",
 *     required={"name", "slug"},
 *     @OA\Property(property="name", ref="#/components/schemas/EmployeeNumberScaleEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/EmployeeNumberScaleEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/EmployeeNumberScaleEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateEmployeeNumberScaleEloquent",
