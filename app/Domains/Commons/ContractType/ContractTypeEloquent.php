 ...
 */
class ContractTypeEloquent extends EloquentAbstract implements ContractTypeInterface
{
     ...
     * @var string
     */
    protected $table =  ContractTypeInterface::TABLE_NAME;
    ...
    {
        return $this->belongsTo(ProjectEloquent::class, 'contract_type_id');
    }
...
/**
 * @OA\Schema(
 *     schema="CreateContractTypeEloquent",
 *     description="Create contract type eloquent",
 *     title="Create contract type eloquent",
 *     required={"name", "slug"},
 *     @OA\Property(property="name", ref="#/components/schemas/ContractTypeEloquent/properties/name"),
 *     @OA\Property(property="slug", ref="#/components/schemas/ContractTypeEloquent/properties/slug"),
 *     @OA\Property(property="description", ref="#/components/schemas/ContractTypeEloquent/properties/description")
 * )
 */

/**
 * @OA\Schema(
 *     schema="UpdateContractTypeEloquent",
 ...
 *              )
 *          ),
 *          @OA\Schema(ref="#/components/schemas/CreateContractTypeEloquent")
 *     }
 * )
 */
