<?php
namespace App\Infrastructures\Commons\Group;
 ...
 */
class EloquentGroupRepository extends EloquentRepositoryAbstract implements EloquentGroupRepositoryInterface
{
