...
use App\Domains\HumanResources\Element\ElementService;
use Mockery as m;
use Tests\TestCase;
...
class ElementServiceTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->repository = m::mock(ElementRepositoryInterface::class);
    ...
    {
        $this->assertInstanceOf(ElementServiceInterface::class, $this->service);
    }
