...
use App\Domains\Applicant\Contracts\ApplicantServiceInterface;
use App\Domains\Applicant\ApplicantEloquent;
use App\Domains\Applicant\ApplicantService;
use Mockery as m;
use Tests\TestCase;
...
class ApplicantServiceTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->repository = m::mock(ApplicantRepositoryInterface::class);
    ...
    {
        $this->assertInstanceOf(ApplicantServiceInterface::class, $this->service);
    }
