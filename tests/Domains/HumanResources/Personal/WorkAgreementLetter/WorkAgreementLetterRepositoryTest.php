...
use App\Domains\WorkAgreementLetter\WorkAgreementLetterRepository;
...
class WorkAgreementLetterRepositoryTest extends TestCase
{
    private $eloquent;
    private $repository;
    ...
    {
        parent::setUp();
        $this->eloquent = m::mock(EloquentWorkAgreementLetterRepositoryInterface::class);
        $this->repository = new WorkAgreementLetterRepository($this->eloquent);
    }
    ...
    {
        $this->assertInstanceOf(WorkAgreementLetterRepositoryInterface::class, $this->repository);
    }

    /**
     * Test create WorkAgreementLetter
     */
    ...
    /**
     * Test delete WorkAgreementLetter
     */
    public function testDelete()
    {
        $note = m::mock(WorkAgreementLetterInterface::class);
    ...
    /**
     * Test Update WorkAgreementLetter
     */
