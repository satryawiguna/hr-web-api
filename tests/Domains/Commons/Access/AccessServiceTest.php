...
use App\Domains\Commons\Access\AccessService;
use Mockery as m;
use Tests\TestCase;
...
class AccessServiceTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->repository = m::mock(AccessRepositoryInterface::class);
    ...
    {
        $this->assertInstanceOf(AccessServiceInterface::class, $this->service);
    }
